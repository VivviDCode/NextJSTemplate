        ...
        <ul className="flex flex-row justify-end items-center gap-2 pl-0 mb-0 list-none md-max:w-full">
          <li className="flex justify-center items-center bg-[#F9FAFB] px-5 rounded-lg h-[48px]">
            <input
              ...
              className="h-[48px] bg-[#F9FAFB] placeholder:text-mygray"
            />
            <span>
              <SearchIcon />
            </span>
            ...
            >
              <div className="w-4.5 overflow-hidden">
                {hideSideBar ? (
                  ...
                  <>
                    {" "}
                    <i className="ease mb-0.75 relative block h-0.5 rounded-sm bg-white transition-all translate-x-[5px]"></i>
                    <i className="ease mb-0.75 relative block h-0.5 rounded-sm bg-white transition-all"></i>
                    <i className="ease relative block h-0.5 rounded-sm bg-white transition-all translate-x-[5px]"></i>
                  </>
                )}
              </div>
            </button>
